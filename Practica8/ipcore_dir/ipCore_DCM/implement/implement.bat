...
xst -ifn xst.scr
move ipCore_DCM_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ipCore_DCM_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ipCore_DCM_exdes.ucf ipCore_DCM_exdes

echo 'Running map'
map -timing -pr b ipCore_DCM_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ipCore_DCM_exdes -w routed.ncd routed.vhd
cd ..
