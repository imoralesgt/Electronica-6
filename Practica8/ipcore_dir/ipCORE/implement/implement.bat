...
xst -ifn xst.scr
move ipCORE_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ipCORE_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ipCORE_exdes.ucf ipCORE_exdes

echo 'Running map'
map -timing -pr b ipCORE_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ipCORE_exdes -w routed.ncd routed.vhd
cd ..
